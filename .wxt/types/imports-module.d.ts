...
declare module '#imports' {
  ...
  export { detectLoginFormFields } from '../utils/form-detector';
  export { getRegisteredApps, saveRegisteredApps, addApp, updateApp, removeApp, matchUrl, findMatchingStep, FormFieldMeta, LoginStep, RegisteredApp } from '../utils/storage';
}
