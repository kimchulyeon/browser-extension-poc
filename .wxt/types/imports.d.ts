...
declare global {
  ...
  const addApp: typeof import('/Users/hama/Desktop/workspace/alphakey-password-manager/utils/storage').addApp
  ...
  const detectLoginFormFields: typeof import('/Users/hama/Desktop/workspace/alphakey-password-manager/utils/form-detector').detectLoginFormFields
  const fakeBrowser: typeof import('wxt/testing').fakeBrowser
  const findMatchingStep: typeof import('/Users/hama/Desktop/workspace/alphakey-password-manager/utils/storage').findMatchingStep
  const getAppConfig: typeof import('wxt/utils/app-config').getAppConfig
  const getRegisteredApps: typeof import('/Users/hama/Desktop/workspace/alphakey-password-manager/utils/storage').getRegisteredApps
  const injectScript: typeof import('wxt/utils/inject-script').injectScript
  const matchUrl: typeof import('/Users/hama/Desktop/workspace/alphakey-password-manager/utils/storage').matchUrl
  const removeApp: typeof import('/Users/hama/Desktop/workspace/alphakey-password-manager/utils/storage').removeApp
  const saveRegisteredApps: typeof import('/Users/hama/Desktop/workspace/alphakey-password-manager/utils/storage').saveRegisteredApps
  const storage: typeof import('wxt/utils/storage').storage
  const updateApp: typeof import('/Users/hama/Desktop/workspace/alphakey-password-manager/utils/storage').updateApp
...
declare global {
  ...
  // @ts-ignore
  export type { FormFieldMeta, LoginStep, RegisteredApp } from '/Users/hama/Desktop/workspace/alphakey-password-manager/utils/storage'
  import('/Users/hama/Desktop/workspace/alphakey-password-manager/utils/storage')
}
